...
CK_C_VISIBLE_PUBLIC void CkByteData_append2(HCkByteData cHandle, const void * pByteData, unsigned long szByteData);
...
CK_C_VISIBLE_PUBLIC BOOL CkByteData_beginsWith2(HCkByteData cHandle, const void * pByteData, unsigned long szByteData);
CK_C_VISIBLE_PUBLIC void CkByteData_borrowData(HCkByteData cHandle, const void * pByteData, unsigned long szByteData);
...
CK_C_VISIBLE_PUBLIC BOOL CkByteData_equals2(HCkByteData cHandle, const void * pCompareBytes, unsigned long numBytes);
CK_C_VISIBLE_PUBLIC int CkByteData_findBytes(HCkByteData cHandle, HCkByteData byteDataObj);
CK_C_VISIBLE_PUBLIC int CkByteData_findBytes2(HCkByteData cHandle, const void * findBytes, unsigned long findBytesLen);
CK_C_VISIBLE_PUBLIC unsigned char CkByteData_getByte(HCkByteData cHandle, unsigned long byteIndex);
CK_C_VISIBLE_PUBLIC const void * CkByteData_getBytes(HCkByteData cHandle);
CK_C_VISIBLE_PUBLIC char CkByteData_getChar(HCkByteData cHandle, unsigned long byteIndex);
CK_C_VISIBLE_PUBLIC const void * CkByteData_getData(HCkByteData cHandle);
CK_C_VISIBLE_PUBLIC const void * CkByteData_getDataAt(HCkByteData cHandle, unsigned long byteIndex);
...
CK_C_VISIBLE_PUBLIC const void * CkByteData_getRange(HCkByteData cHandle, unsigned long byteIndex, unsigned long numBytes);
...
CK_C_VISIBLE_PUBLIC const void * CkByteData_removeData(HCkByteData cHandle);
