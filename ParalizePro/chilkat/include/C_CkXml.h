...
CK_C_VISIBLE_PUBLIC BOOL CkXml_SetBinaryContent2(HCkXml cHandle, const void * pByteData, unsigned long szByteData, BOOL zipFlag, BOOL encryptFlag, const char *password);
#endif
