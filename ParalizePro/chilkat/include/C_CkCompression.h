...
CK_C_VISIBLE_PUBLIC BOOL CkCompression_BeginCompressBytes2(HCkCompression cHandle, const void * pByteData, unsigned long szByteData, HCkByteData outBytes);
...
CK_C_VISIBLE_PUBLIC BOOL CkCompression_BeginDecompressBytes2(HCkCompression cHandle, const void * pByteData, unsigned long szByteData, HCkByteData outBytes);
...
CK_C_VISIBLE_PUBLIC BOOL CkCompression_CompressBytes2(HCkCompression cHandle, const void * pByteData, unsigned long szByteData, HCkByteData outBytes);
...
CK_C_VISIBLE_PUBLIC BOOL CkCompression_DecompressBytes2(HCkCompression cHandle, const void * pByteData, unsigned long szByteData, HCkByteData outBytes);
...
CK_C_VISIBLE_PUBLIC BOOL CkCompression_MoreCompressBytes2(HCkCompression cHandle, const void * pByteData, unsigned long szByteData, HCkByteData outBytes);
...
CK_C_VISIBLE_PUBLIC BOOL CkCompression_MoreDecompressBytes2(HCkCompression cHandle, const void * pByteData, unsigned long szByteData, HCkByteData outBytes);
