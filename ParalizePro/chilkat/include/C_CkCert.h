...
CK_C_VISIBLE_PUBLIC BOOL CkCert_LoadFromBinary2(HCkCert cHandle, const void * pByteData, unsigned long szByteData);
#endif
...
#if !defined(CHILKAT_MONO)
CK_C_VISIBLE_PUBLIC BOOL CkCert_LoadPfxData2(HCkCert cHandle, const void * pByteData, unsigned long szByteData, const char *password);
#endif
