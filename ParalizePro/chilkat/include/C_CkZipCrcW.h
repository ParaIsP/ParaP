...
CK_C_VISIBLE_PUBLIC BOOL CkZipCrcW_ToHex(HCkZipCrcW cHandle, int crc, HCkString outStr);
CK_C_VISIBLE_PUBLIC const wchar_t *CkZipCrcW_toHex(HCkZipCrcW cHandle, int crc);
#endif
