...
CK_C_VISIBLE_PUBLIC void CkEmail_AddRelatedData2P(HCkEmail cHandle, const void * pBytes, unsigned long szBytes, const char *fileNameInHtml);
#endif
#if !defined(CHILKAT_MONO)
CK_C_VISIBLE_PUBLIC BOOL CkEmail_AddRelatedDataP(HCkEmail cHandle, const char *nameInHtml, const void * pBytes, unsigned long szBytes, HCkString outStrContentId);
CK_C_VISIBLE_PUBLIC const char *CkEmail_addRelatedDataP(HCkEmail cHandle, const char *nameInHtml, const void * pBytes, unsigned long szBytes);
#endif
