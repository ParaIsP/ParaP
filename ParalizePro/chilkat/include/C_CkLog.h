...
CK_C_VISIBLE_PUBLIC void CkLog_LogDataBase64_2(HCkLog cHandle, const char *tag, const void * pByteData, unsigned long szByteData);
CK_C_VISIBLE_PUBLIC void CkLog_LogDataHex(HCkLog cHandle, const char *tag, HCkByteData data);
CK_C_VISIBLE_PUBLIC void CkLog_LogDataHex2(HCkLog cHandle, const char *tag, const void * pByteData, unsigned long szByteData);
...
CK_C_VISIBLE_PUBLIC void CkLog_LogHash2(HCkLog cHandle, const char *tag, const char *hashAlg, const void * pByteData, unsigned long szByteData);
