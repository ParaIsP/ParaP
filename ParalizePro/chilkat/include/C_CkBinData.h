...
CK_C_VISIBLE_PUBLIC BOOL CkBinData_AppendBinary2(HCkBinData cHandle, const void * pByteData, unsigned long szByteData);
...
CK_C_VISIBLE_PUBLIC const void * CkBinData_GetBytesPtr(HCkBinData cHandle);
...
CK_C_VISIBLE_PUBLIC BOOL CkBinData_LoadBinary2(HCkBinData cHandle, const void * pByteData, unsigned long szByteData);
