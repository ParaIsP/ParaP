...
CK_C_VISIBLE_PUBLIC BOOL CkZipCrc_ToHex(HCkZipCrc cHandle, int crc, HCkString outStr);
CK_C_VISIBLE_PUBLIC const char *CkZipCrc_toHex(HCkZipCrc cHandle, int crc);
#endif
