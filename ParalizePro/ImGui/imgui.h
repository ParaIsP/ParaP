...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginCustom(const char* name, bool* p_open, ImGuiWindowFlags flags);
    IMGUI_API void          End();
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_Custom                 = 1 << 29   // Don't use! For internal use by BeginMenu()
...
struct ImGuiIO
{
    ...
    bool        WantCaptureHotkey;            // When its true we want to capture all keys for hotkey
